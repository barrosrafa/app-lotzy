...
const links: ReadonlyArray<readonly [string, string]> = [['/', 'Gerar'], ['/historico', 'Histórico'], ['/filtros', 'Filtros'], ['/validar', 'Validar'], ['/analisar', 'Analisar'], ['/conferir', 'Conferir'], ['/ferramentas', 'Ferramentas'], ['/carteira', 'Carteira']];

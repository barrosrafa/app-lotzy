...
const links: ReadonlyArray<readonly [string, string]> = [['/', 'Gerar'], ['/ia', 'IA'], ['/filtros', 'Filtros'], ['/analisar', 'Analisar'], ['/estatisticas', 'Estatísticas'], ['/montar', 'Montar'], ['/meus-jogos', 'Meus jogos'], ['/history', 'Histórico'], ['/ajuda', 'Ajuda']];

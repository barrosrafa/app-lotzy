...
const links: ReadonlyArray<readonly [string, string]> = [['/', 'Gerar'], ['/filtros', 'Filtros'], ['/analisar', 'Analisar'], ['/estatisticas', 'Estatísticas'], ['/conferir', 'Conferir'], ['/montar', 'Montar'], ['/meus-jogos', 'Meus jogos'], ['/imprimir', 'Imprimir'], ['/history', 'Histórico'], ['/ajuda', 'Ajuda']];
